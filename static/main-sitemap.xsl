<?xml version="1.0" encoding="UTF-8"?>
	...
	<xsl:template match="/">
		...
		<div id="content">
			<h1>XML Sitemap</h1>
			<p class="expl">
				Generated by Ha Son (Tom) Do from <a href="https://fcl.software" target="_blank" rel="noopener">Future Corporation</a>, this is an XML Sitemap, meant for consumption by search engines.<br/>
